...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class SetOsdEnabled  : public Action
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
public:
    virtual const char *GetName() override { return "SetOsdEnabled"; }

    void Do(ActionContext *context, double value) override
    {
        if (value == ActionContext::BUTTON_RELEASE_MESSAGE_VALUE) return;
        
        context->GetSurface()->SetOsdEnabled(0 != strcmp(context->GetStringParam(), "No"));
    }
};
...
{
public:
    virtual const char *GetName() override { return "SetOSDTime"; }
